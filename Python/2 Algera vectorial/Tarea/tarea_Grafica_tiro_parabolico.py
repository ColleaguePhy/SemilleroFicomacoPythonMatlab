...
X, Y = linspace(0,0,n), linspace(0,0,n)
U = x
V = y
...
rc('font',size=16)
Q = quiver(X, Y, U, V, scale_units='xy',angles='xy',scale=1,color='blue',width=0.003)
Q2= quiver(U,V,vx,vy,scale_units='xy',angles='xy',scale=5,color='cyan',width=0.003)
